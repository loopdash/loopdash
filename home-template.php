					...
					<div class="mt-10">
						<dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-x-8 md:gap-y-10">
							...
							<?php 
								...
								$featureDescription = "Changes are inevitable, therefore software is never truly finished. Our software support team keeps your product secure, maintained, and enhanced regardless of what happens.";
								include 'feature-callout.php';
							?>
						</dl>
					</div>
