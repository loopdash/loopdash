...
proposal:
  ...
  description: We will design and develop a clean, modern website for Protect Your Check, inspired by the Hub's logo concepts.
  summary: |
    ...
    <br /><br />
    The full project has an estimated timeline of 2-3 weeks to deliver an effective outcome. Please feel free to read more <a href="/about" target="_blank" class="link plausible-event-name=Proposal+About+Link+Click">about us</a> or refer to our <a href="/faq" target="_blank" class="link plausible-event-name=Proposal+FAQ+Link+Click">commonly asked questions</a>.
    <br /><br />
  website: protectyourcheck.com
  video: | 
    <div style="position: relative; padding-bottom: 56.25%; height: 0;"><iframe src="https://www.loom.com/embed/9f7d00832d9e43f3aab8a1bcc6c67d63?sid=ab3f911c-c151-4388-95e9-d4e13850e1ae" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe></div>
  price: $15,500
  duration: 2-3 weeks
  services:
  - name: Design
    description: Create and refine design elements to align with branding.
    duration: 1 week
  - name: Development
    description: Convert design files into a WordPress site.
    duration: 1 week
  - name: CMS Setup & Content Integration
    description: Implement templates and integrate content.
    duration: 1 week
  - name: Feedback and Revisions
    description: Implement templates and integrate content.
    duration: 3-4 days
  - name: Testing & Launch
    description: Pre-launch testing and deployment.
    duration: 3-4 days
...
tags: proposals
date: 2025-06-11
url: /proposals/protect-your-check
---