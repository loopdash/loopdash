...
function blankslate_load_scripts() {
  wp_enqueue_style('style', get_template_directory_uri() . '/assets/style.css', false);
  wp_enqueue_style( 'adamina', 'https://fonts.googleapis.com/css2?family=Adamina&display=swap' );
